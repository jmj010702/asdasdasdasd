package com.beyond.Pocha_On.store.controller;

import com.beyond.Pocha_On.store.dtos.*;
import com.beyond.Pocha_On.store.service.StoreService;
...
public class StoreController {
    ...
    public ResponseEntity<?> updateTime(@PathVariable Long storeId, @RequestBody StoreUpdateTimeDto dto, String email){
        storeService.updateTime(storeId,dto, email);
