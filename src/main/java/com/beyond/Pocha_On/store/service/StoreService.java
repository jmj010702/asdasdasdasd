package com.beyond.Pocha_On.store.service;
...
import com.beyond.Pocha_On.store.dtos.StoreCreateDto;
import com.beyond.Pocha_On.store.dtos.StoreListDto;
import com.beyond.Pocha_On.store.dtos.StoreTokenDto;
import com.beyond.Pocha_On.store.dtos.StoreUpdateTimeDto;
...
public class StoreService {
    ...
    @Transactional
    public void updateTime(Long storeId, StoreUpdateTimeDto dto, String email){
        Owner owner = ownerRepository.findByOwnerEmail(email)
                .orElseThrow(() -> new EntityNotFoundException("Owner not found"));
        Store store = storeRepository.findById(storeId)
                .orElseThrow(() -> new EntityNotFoundException("Store not found"));
